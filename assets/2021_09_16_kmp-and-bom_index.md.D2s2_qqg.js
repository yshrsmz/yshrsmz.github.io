import{_ as n,o as e,a as t,P as s}from"./chunks/framework.IplDhfGE.js";const g=JSON.parse('{"title":"Kotlin Multiplatform Project で BOM(Bill of Materials)を使う","description":"","frontmatter":{"layout":"post","title":"Kotlin Multiplatform Project で BOM(Bill of Materials)を使う","category":"programming","tags":["kotlin","kmp","gradle","TIL"],"head":[["link",{"rel":"canonical","href":"https://www.codingfeline.com/2021/09/16/kmp-and-bom/"}],["meta",{"property":"og:url","content":"https://www.codingfeline.com/2021/09/16/kmp-and-bom/"}],["meta",{"property":"og:title","content":"Kotlin Multiplatform Project で BOM(Bill of Materials)を使う"}],["meta",{"property":"twitter:card","content":"summary_large_image"}],["meta",{"property":"twitter:site","content":"@_yshrsmz"}],["meta",{"property":"twitter:creator","content":"@_yshrsmz"}],["meta",{"property":"og:image","content":"https://www.codingfeline.com/2021/09/16/kmp-and-bom/ogp.png"}]]},"headers":[],"relativePath":"2021/09/16/kmp-and-bom/index.md","filePath":"posts/2021/2021-09-16-kmp-and-bom.md","date":{"time":"2021-09-16","string":"September 16, 2021","year":"2021","month":"09","day":"16"}}'),r={name:"2021/09/16/kmp-and-bom/index.md"};function l(i,a,p,o,u,c){return e(),t("div",null,[...a[0]||(a[0]=[s(`<p>maven の BOM を使おうと思って Kotlin Multiplatform Project で下記のように書いてもうまく動かず、よくわからないエラーが出る。</p><div class="language-groovy"><button title="Copy Code" class="copy"></button><span class="lang">groovy</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">apply </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">plugin</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;org.jetbrains.kotlin.multiplatform&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>↓よくわからんエラーの例</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>Build file &#39;/Users/yshrsmz/repos/github.com/yshrsmz/kmp-app/presentation/presentation-all/build.gradle&#39; line: 15</span></span>
...
<span class="line"><span>	... 141 more</span></span></code></pre></div><p>エラーメッセージから何もわからなくて途方に暮れそうになるんだけど、<code>MissingMethodException</code> ということで「存在しないメソッド」を呼んでいるらしい。<br> ただ、サジェストされるメソッドが的はずれすぎて一体なにを間違えてるのかわからない。</p><p>そこからいろいろリバートしたりしながら切り分けていくと <code>platform()</code> があやしい。 どうやら Kotlin Multiplatform Plugin は <code>platform()</code> をサポートしていないようだ。</p><p>Kotlin のフォーラムや YouTrack を見たところ、</p><div class="language-groovy"><button title="Copy Code" class="copy"></button><span class="lang">groovy</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">implementation project</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">dependencies</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">platform(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;org.jetbrains.kotlinx:kotlinx-coroutines-bom:1.5.2-native-mt&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p>的に書いて Gradle 本体のメソッドを使えばよいらしく、そう書けばたしかにうまく動いてそう。</p><p><a href="https://youtrack.jetbrains.com/issue/KT-40489" target="_blank" rel="noreferrer">YouTrack の issue</a>を見る限りだと、 JetBrains 的には <code>platform()</code> や <code>enforcedPlatform()</code> を実装する予定は今のところなさそうな雰囲気。</p><hr><p>Gradleのエラーメッセージまじわからんわ、という話でした。</p><h2 id="参考" tabindex="-1">参考 <a class="header-anchor" href="#参考" aria-label="Permalink to “参考”">​</a></h2><ul><li><a href="https://discuss.kotlinlang.org/t/kotlin-bom-in-multiplatform-projects/19694/2" target="_blank" rel="noreferrer">Kotlin-bom in multiplatform projects? - Multiplatform - Kotlin Discussions</a></li><li><a href="https://youtrack.jetbrains.com/issue/KT-40489" target="_blank" rel="noreferrer">MPP / Gradle: support BOM (enforcedPlatform) artifacts in source set dependencies DSL : KT-40489</a></li></ul>`,14)])])}const f=n(r,[["render",l]]);export{g as __pageData,f as default};
