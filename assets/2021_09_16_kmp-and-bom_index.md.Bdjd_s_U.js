...
<span class="line"><span>	... 141 more</span></span></code></pre></div><p>エラーメッセージから何もわからなくて途方に暮れそうになるんだけど、<code>MissingMethodException</code> ということで「存在しないメソッド」を呼んでいるらしい。<br> ただ、サジェストされるメソッドが的はずれすぎて一体なにを間違えてるのかわからない。</p><p>そこからいろいろリバートしたりしながら切り分けていくと <code>platform()</code> があやしい。 どうやら Kotlin Multiplatform Plugin は <code>platform()</code> をサポートしていないようだ。</p><p>Kotlin のフォーラムや YouTrack を見たところ、</p><div class="language-groovy vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">groovy</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">implementation project</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">dependencies</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">platform(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;org.jetbrains.kotlinx:kotlinx-coroutines-bom:1.5.2-native-mt&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p>的に書いて Gradle 本体のメソッドを使えばよいらしく、そう書けばたしかにうまく動いてそう。</p><p><a href="https://youtrack.jetbrains.com/issue/KT-40489" target="_blank" rel="noreferrer">YouTrack の issue</a>を見る限りだと、 JetBrains 的には <code>platform()</code> や <code>enforcedPlatform()</code> を実装する予定は今のところなさそうな雰囲気。</p><hr><p>Gradleのエラーメッセージまじわからんわ、という話でした。</p><h2 id="参考" tabindex="-1">参考 <a class="header-anchor" href="#参考" aria-label="Permalink to &quot;参考&quot;">​</a></h2><ul><li><a href="https://discuss.kotlinlang.org/t/kotlin-bom-in-multiplatform-projects/19694/2" target="_blank" rel="noreferrer">Kotlin-bom in multiplatform projects? - Multiplatform - Kotlin Discussions</a></li><li><a href="https://youtrack.jetbrains.com/issue/KT-40489" target="_blank" rel="noreferrer">MPP / Gradle: support BOM (enforcedPlatform) artifacts in source set dependencies DSL : KT-40489</a></li></ul>`,14),l=[r];function i(p,o,u,c,d,g){return e(),n("div",null,l)}const f=a(s,[["render",i]]);export{m as __pageData,f as default};
